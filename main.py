...
#Initialize tracker
    ...
    for frame_num, player_track in enumerate(tracks['players']):
        ...
        if assigned_player != -1:
            ...
            team_ball_control.append(team_ball_control[-1]) #if no player has the ball, the team with ball control remains the same as the previous frame
    ...
    save_video(output_video_frames, "output_videos/08fd33_4_output.avi")
